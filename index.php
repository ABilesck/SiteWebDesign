    ...
    if(isset($_SESSION['id']))
    {
        ?>
            ...
            <div class="fundo2">
                ...
                {
                    echo 'Ops... Parece que você não participa de nenhuma comunidade. Utilize a barra de buscar para participar das melhores comunidades do Codificando!';
        ...
        <div class="fundo">
            <div class="form">
                ...
                <form method="POST", action="./DAO/perfil/logar.php">
                    ...
                    <button type="button" class="btnSecundario" onclick="window.location.href='./view/criarPerfil.php'">
                        Criar conta
